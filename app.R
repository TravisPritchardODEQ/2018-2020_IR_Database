    ...
    mainPanel(
      tabsetPanel(type = "tabs",
                  ...
                  tabPanel("Instructions",
                           ...
                           p("The DEQ 2018/2020 IR webpage page can be found", a("here.", href="https://www.oregon.gov/deq/wq/Pages/epaApprovedIR.aspx", target="_blank"), style = "font-family: 'times'"),
